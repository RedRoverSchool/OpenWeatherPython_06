...
from tests.test_group_lutz_squad.locators.members_page_lacators import MembersPageLocators
from tests.test_group_lutz_squad.test_data.members_page_data import names_of_fields_for_individual as ind,\
