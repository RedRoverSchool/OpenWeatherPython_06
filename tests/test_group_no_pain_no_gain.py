...
correct_login = 'murzin199593@gmail.com'
...
def test_authorization(driver):
    ...
    user_name.send_keys(correct_login)
    password = driver.find_element(By.XPATH, "//input[@id='user_password']")
    password.send_keys(correct_password)
    submit_btn = driver.find_element(By.XPATH, "//input[@name='commit']")
    submit_btn.click()
    notice = driver.find_element(By.XPATH, "//*[@class='panel-body']")
