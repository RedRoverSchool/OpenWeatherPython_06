...
class Footer(BasePage):
    ...
    def check_redirection_to_about_us_page(self):
        element = wait(self.driver, 10).until(EC.presence_of_element_located(self.locators.ABOUT_US))
        self.driver.execute_script("arguments[0].scrollIntoView();", element)
        element.click()
        wait(self.driver, 10).until(EC.url_to_be(ABOUT_US_URL))
