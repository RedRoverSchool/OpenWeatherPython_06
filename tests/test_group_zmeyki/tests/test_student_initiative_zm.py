from tests.test_group_zmeyki.pages.student_initiative_page import StudentInitiativePage


class TestStudentInitiativePage:

    def test_tc_010_02_07_verify_website_link_redirects_to_main_page(self, driver, wait):
