import pytest
from tests.group_files.pandoras_box.test_data.header_data import URLs
from tests.group_files.pandoras_box.pages.header import Header
from tests.group_files.pandoras_box.pages.search_result_page import SearchResultPage
