from tests.group_files.group_trust_me_i_am_engineer.pages.marketplace_page import MarketplacePage
...
def test_TC_007_02_08_verify_visibility_clickability_labels_checkbox(driver):
    page = MarketplacePage(driver)
