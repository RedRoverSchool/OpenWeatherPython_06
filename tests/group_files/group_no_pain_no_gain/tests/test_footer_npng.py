from tests.group_files.group_no_pain_no_gain.pages.footer import Footer
from tests.group_files.group_no_pain_no_gain import links
from tests.group_files.group_no_pain_no_gain.locators.footer_locators import FooterLocators as FL
