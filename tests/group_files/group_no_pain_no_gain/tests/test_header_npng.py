from tests.group_files.group_no_pain_no_gain.pages.header import Header
from tests.group_files.group_no_pain_no_gain.locators.header_locators import HeaderLocators as HL
