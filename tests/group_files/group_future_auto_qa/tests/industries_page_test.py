from tests.group_files.group_future_auto_qa.locators.industries_page_locators import IndustriesPageLocators
from tests.group_files.group_future_auto_qa.pages.industries_page import IndustriesPage
import pytest
