from tests.group_files.group_future_auto_qa.pages.main_page import MainPage
from tests.group_files.group_future_auto_qa.pages.main_page import MainPageFooter
from tests.group_files.group_future_auto_qa.pages.main_page import MainPageHourlyForecast
import pytest
