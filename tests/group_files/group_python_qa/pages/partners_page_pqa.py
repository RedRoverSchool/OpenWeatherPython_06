...
from tests.group_files.group_python_qa.locators.locators import PartnersAndSolutionsLocators
from tests.group_files.group_python_qa.links.links_all_pages import WEATHER_INDICATOR_PAGE
