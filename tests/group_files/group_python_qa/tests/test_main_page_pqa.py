...
from tests.group_files.group_python_qa.locators.locators import MainPageLocators
from tests.group_files.group_python_qa.pages.main_page_pqa import MainPage
from tests.group_files.group_python_qa.links.links_all_pages import QUALITY_INFO_PAGE
