from tests.group_files.group_python_qa.links.links_all_pages import OPENAGRO_PAGE, AGRICULTURAL_ANALYTICS_FORM
from tests.group_files.group_python_qa.pages.openagro_page_pqa import OpeAgroPage
