...
from tests.group_files.group_lutz_squad.locators.guide_page_locators import GuidePageLocators
from selenium.webdriver.support.color import Color

from tests.group_files.group_lutz_squad.test_data.data import industry_apis_link_color_hex
from tests.group_files.group_lutz_squad.test_data.data import one_call_api_link_color_hex
from tests.group_files.group_lutz_squad.locators.links import API_PAGE_LINK
from tests.group_files.group_lutz_squad.locators.links import ONE_CALL_3_LINK
