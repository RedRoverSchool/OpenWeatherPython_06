from tests.group_files.group_lutz_squad.pages.cookies_settings_page import CookiesSettingsPage
from tests.group_files.group_lutz_squad.locators.cookies_settings_page_locators import \
