from tests.group_files.group_lutz_squad.pages.partners_and_solutions_page import PartnersAndSolutionsPage
from tests.group_files.group_lutz_squad.locators.partners_and_solutions_page_locators import PartnersAndSolutionsPageLocators as PAS
