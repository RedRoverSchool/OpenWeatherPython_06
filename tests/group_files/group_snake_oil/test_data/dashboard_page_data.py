from tests.group_files.group_snake_oil.locators.dashboard_locators import DashboardPageLocators
from tests.group_files.group_snake_oil.links.all_links import EXPEXTED_URLS_SIGNED_IN_LIST, EXPECTED_URLS_SIGNED_OUT_LIST
