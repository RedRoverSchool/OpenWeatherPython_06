from tests.group_files.group_snake_oil.links.all_links import StudentInitiativePageLinks
from tests.group_files.group_snake_oil.pages.student_initiative_page import StudentInitiativePage
