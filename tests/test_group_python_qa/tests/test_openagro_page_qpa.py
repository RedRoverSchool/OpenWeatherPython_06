from tests.test_group_python_qa.links.links_all_pages import OPENAGRO_PAGE, AGRICULTURAL_ANALYTICS_FORM
from tests.test_group_python_qa.pages.openagro_page_pqa import OpeAgroPage
from tests.test_group_python_qa.locators.locators import OpenAgroLocators
