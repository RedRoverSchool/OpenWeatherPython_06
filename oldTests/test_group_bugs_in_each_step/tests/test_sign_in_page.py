from oldTests.test_group_bugs_in_each_step.pages.sign_in_page import SignInPage
from oldTests.test_group_bugs_in_each_step.test_data.urls import SignInUrls
from oldTests.test_group_bugs_in_each_step.pages.profile_page import ProfilePage
