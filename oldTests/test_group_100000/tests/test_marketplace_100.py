...
import pytest
from oldTests.test_group_100000.pages.marketplace_page import *
from oldTests.test_group_100000.locators.marketplace_page_locators import MarketplaceLocators as M
...
class TestMarketplacePage:
    ...
    def test_TC_007_03_02_Verify_visibility_of_location_name_on_the_map(self, driver, wait):
        ...
        displayed_text = marketplace_page.find_displayed_text(wait=wait)
