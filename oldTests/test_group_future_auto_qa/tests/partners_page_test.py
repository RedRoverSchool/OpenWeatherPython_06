from oldTests.test_group_future_auto_qa.pages.partners_page import PartnersPage
from oldTests.test_group_future_auto_qa.test_data.urls import APACHE_CAMEL_URL
