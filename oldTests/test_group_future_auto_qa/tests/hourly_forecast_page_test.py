from oldTests.test_group_future_auto_qa.pages.hourly_forecast_page import HourlyForecastPage
from oldTests.test_group_future_auto_qa.locators.hourly_forecast_page_locators import HourlyForecastPageLocators
import pytest
