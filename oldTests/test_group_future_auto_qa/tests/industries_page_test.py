from oldTests.test_group_future_auto_qa.locators.industries_page_locators import IndustriesPageLocators
from oldTests.test_group_future_auto_qa.pages.industries_page import IndustriesPage
import pytest
