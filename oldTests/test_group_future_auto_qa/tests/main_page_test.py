from oldTests.test_group_future_auto_qa.pages.main_page import MainPage
from oldTests.test_group_future_auto_qa.pages.main_page import MainPageFooter
from oldTests.test_group_future_auto_qa.pages.main_page import MainPageHourlyForecast
import pytest
