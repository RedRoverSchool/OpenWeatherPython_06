...
from oldTests.test_group_future_auto_qa.locators.partners_page_locators import PartnersLocators
from oldTests.test_group_future_auto_qa.test_data.urls import PARTNERS_AND_SOLUTIONS
