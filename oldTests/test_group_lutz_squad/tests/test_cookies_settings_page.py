from oldTests.test_group_lutz_squad.pages.cookies_settings_page import CookiesSettingsPage
from oldTests.test_group_lutz_squad.locators.cookies_settings_page_locators import \
