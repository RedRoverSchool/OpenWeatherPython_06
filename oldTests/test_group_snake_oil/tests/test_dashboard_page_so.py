from oldTests.test_group_snake_oil.links.all_links import DASHBOARD_PAGE_URL
from oldTests.test_group_snake_oil.pages.dashboard_page import DashboardPage
from oldTests.test_group_snake_oil.test_data.dashboard_page_data import EXPECTED_URLS_AND_LOCATORS_SIGNED_IN, \
