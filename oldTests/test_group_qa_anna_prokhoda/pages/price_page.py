...
from oldTests.test_group_qa_anna_prokhoda.locators.price_page_locators import PricePageLocators
from oldTests.test_group_qa_anna_prokhoda.links.links import main_page_url
