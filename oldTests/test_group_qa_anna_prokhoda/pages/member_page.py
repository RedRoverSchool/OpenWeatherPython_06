...
from oldTests.test_group_qa_anna_prokhoda.locators.member_page_loc import MemberPageLocators as locator
from oldTests.test_group_qa_anna_prokhoda.links.links import member_page_url
