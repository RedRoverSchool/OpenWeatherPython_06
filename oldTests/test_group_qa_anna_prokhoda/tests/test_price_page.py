from oldTests.test_group_qa_anna_prokhoda.pages.price_page import PricePage
from oldTests.test_group_qa_anna_prokhoda.links.links import price_page_url
