from oldTests.test_group_optimists_of_rationality_middle_devs.locators.dashboard_page_locators import DashboardLocators
from oldTests.test_group_optimists_of_rationality_middle_devs.pages.dashboard_page import Dashboard
