import pytest
from oldTests.test_pandoras_box.test_data.header_data import URLs
from oldTests.test_pandoras_box.pages.header import Header
from oldTests.test_pandoras_box.pages.search_result_page import SearchResultPage
