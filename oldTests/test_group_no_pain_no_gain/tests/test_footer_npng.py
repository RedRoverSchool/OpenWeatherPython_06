from oldTests.test_group_no_pain_no_gain.pages.footer import Footer
from oldTests.test_group_no_pain_no_gain import links
from oldTests.test_group_no_pain_no_gain.locators.footer_locators import FooterLocators as FL
