from oldTests.test_group_python_qa.pages.cookies_settings_page_pqa import CookiesSettings
from oldTests.test_group_python_qa.links.links_all_pages import *
