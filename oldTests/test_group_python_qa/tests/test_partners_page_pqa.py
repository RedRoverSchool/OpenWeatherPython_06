from oldTests.test_group_python_qa.pages.partners_page_pqa import PartnersAndSolutions
from oldTests.test_group_python_qa.links.links_all_pages import PARTNERS_AND_SOLUTION_PAGE, GO_LIBRARY_PAGE
from oldTests.test_group_python_qa.locators.locators import PartnersAndSolutionsLocators as loc
