from oldTests.test_group_python_qa.links.links_all_pages import GUIDE_PAGE, URL_HISTORY_BULK
from oldTests.test_group_python_qa.locators.locators import GuidePageLocators
from oldTests.test_group_python_qa.pages.guide_page import GuidePage
