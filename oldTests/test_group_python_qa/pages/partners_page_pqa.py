...
from oldTests.test_group_python_qa.locators.locators import PartnersAndSolutionsLocators
from oldTests.test_group_python_qa.links.links_all_pages import WEATHER_INDICATOR_PAGE
