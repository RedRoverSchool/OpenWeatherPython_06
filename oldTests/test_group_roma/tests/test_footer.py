import pytest
from oldTests.test_group_roma.test_data.footer_data import data
from oldTests.test_group_roma.pages.footer import FooterComponent
from oldTests.test_group_roma import links
from oldTests.test_group_roma.locators.locators import FooterLocators
